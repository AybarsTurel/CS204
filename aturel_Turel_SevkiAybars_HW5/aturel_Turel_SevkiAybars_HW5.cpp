/*************
Purpose: The purpose of the program is that it will store and display the shared cars information and the drivers who shared the same car. 
Usage: There are no txt files to be used in program but Car.cpp, Car.h, Driver.h and Driver.cpp files have been used in this program.
Author: Sevki Aybars Turel 28238
Date: 29/11/2021
Any known bugs: There are any known bugs.
References: Car.cpp, Car.h, Driver.h and Driver.cpp files were created. Main.cpp file was taken from homework file.
**************/
